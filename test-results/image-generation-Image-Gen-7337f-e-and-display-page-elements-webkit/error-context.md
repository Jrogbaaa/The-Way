...
- Name: Image Generation Flow >> should navigate to models page and display page elements
- Location: /Users/JackEllis/THE WAY /e2e/image-generation.spec.ts:9:7
...
Call log:
  ...
  - waiting for getByTestId('page-title')
    ...
    at /Users/JackEllis/THE WAY /e2e/image-generation.spec.ts:11:50
```
