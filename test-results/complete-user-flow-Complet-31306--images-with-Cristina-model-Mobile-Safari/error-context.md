...
- Name: Complete User Flow - Image Generation with Flux LoRA Models >> User can generate images with Cristina model
- Location: /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:53:7
...
Locator: locator('h1')
Expected string: "Cristina"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h1')

    at /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:58:38
```
