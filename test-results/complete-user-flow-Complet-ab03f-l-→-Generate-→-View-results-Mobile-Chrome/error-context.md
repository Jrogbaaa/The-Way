...
- Name: Complete User Flow - Image Generation with Flux LoRA Models >> User flow: Browse models → Select model → Generate → View results
- Location: /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:190:7
...
Locator: locator('text=Jaime Creator')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('text=Jaime Creator')

    at /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:195:54
```
