...
- Name: Complete User Flow - Image Generation with Flux LoRA Models >> User can test SDXL model for general image generation
- Location: /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:157:7
...
Locator: locator('h1')
Expected string: "SDXL"
Received string: "Stable Diffusion XL"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="jsx-656148ddeca55411 text-2xl font-bold text-gray-900">Stable Diffusion XL</h1>
      - unexpected value "Stable Diffusion XL"

    at /Users/JackEllis/THE WAY /e2e/complete-user-flow.spec.ts:162:38
```
