...
- Name: Image Generation Flow >> should display model creation option
- Location: /Users/JackEllis/THE WAY /e2e/image-generation.spec.ts:18:7
...
Locator: getByTestId('create-model-button')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('create-model-button')

    at /Users/JackEllis/THE WAY /e2e/image-generation.spec.ts:21:32
```
